...
pub fn hex_label(hex: Hex) -> String {
    format!("hex {} (q={}, r={})", hex.index().to_spiral(), hex.q, hex.r)
}

pub fn path_label(path: BoardPath) -> String {
...
pub fn intersection_label(intersection: Intersection) -> String {
...
pub fn build_label(build: Build) -> String {
    match build {
...
pub fn bank_trade_label(trade: BankTrade) -> String {
