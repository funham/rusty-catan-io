...
use catan_core::{
    gameplay::{
        field::PortPos,
        game::projection::PublicGameProjection,
        primitives::{
            PortKind, Tile,
...
impl FieldRenderer {
    ...
    pub fn draw_game(&mut self, view: &PublicGameProjection) {
        self.clear();
...
mod tests {
    use catan_core::{
        ...
        gameplay::game::projection::{
            BoardProjection, PlayerBuildProjection, PublicBankDevCardsProjection,
            PublicBankProjection, PublicBankResourcesProjection, PublicGameProjection,
        },
        gameplay::game::state::SetupGameState,
        gameplay::primitives::{player::PlayerId, resource::ResourceSet},
    };
    ...
    fn renders_default_game_field() {
        ...
        let view = PublicGameProjection {
            board: BoardProjection::from_board(&init.board),
    ...
    fn test_bank() -> PublicBankProjection {
        PublicBankProjection {
            resources: PublicBankResourcesProjection::Exact(ResourceSet::EMPTY),
            dev_cards: PublicBankDevCardsProjection::Exact(0),
        }
    }
}
